function addContactOpenClose() {
  ...
  function editLoadContact() {
    ...
    const e = document.getElementById('details-emailID').innerText;
    const p = document.getElementById('details-phoneID').innerText;
    const img = document.getElementById('img-details-divID');
    document.getElementById('edit-nameID').value = n;
    document.getElementById('edit-emailID').value = e;
    document.getElementById('edit-phoneID').value = p;
    const t = document.getElementById('img-edit-divID');
    t.style.backgroundColor = img.style.backgroundColor;
    t.innerHTML = img.innerHTML;
  }
  ...
  function collectDataForSaving() {
    const n = document.getElementById('add-nameID').value;
