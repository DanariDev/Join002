...
function contactDetailsLoad(idNumber, indexaAlphabet, indexContacs) {
    ...
    detailDiv.classList.toggle('toggle-flex');
...
function backToContactsList() {
    document.getElementById('right-section').classList.remove('toggle-flex');
    document.querySelectorAll('.contact-wrapper').forEach(element => {
        element.style = "";
    });
    document.getElementById('contacts-details-contentsID').classList.remove('toggle-flex');
};
